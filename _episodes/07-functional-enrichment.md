...
- [Introduction: functional enrichment](#introduction-functional-enrichment)
- [1. Gene Ontology enrichment analysis](#1-gene-ontology-enrichment-analysis)
...
- [4.Gene Ontology Over Representation Analysis with AgriGO \(webtool\)](#4gene-ontology-over-representation-analysis-with-agrigo-webtool)
  ...
  - [4.4 Gene Set Enrichment Analysis \(GSEA\)](#44-gene-set-enrichment-analysis-gsea)
